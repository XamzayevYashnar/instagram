...
from .views import (
    home_view, like_post, like_view, delete_post, view_story,
    add_post, profile_view, edit_user, my_videos, add_comment,
    following_add, followers_list, following_list, add_story
)
...
urlpatterns = [
    ...
    path("edit-profile/<int:user_id>/", edit_user, name="edit_profile"),
]
